...
So let's look at our three tools.
...
Goal 2: You have tested some one else's games and constructively feedback to the developers, ideas, improvements, etc. Testing is an important part of Computing.
